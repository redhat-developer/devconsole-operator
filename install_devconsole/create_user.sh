...
sleep 15s
echo -e "\e[1;35m User consoledeveloper created with the password developer. Type the below\e[0m"
echo -e "\e[1;32m oc login -u\e[3m \e[1;36mconsoledeveloper\e[0m \e[1;32m-p\e[3m \e[1;36mdeveloper\e[0m"
