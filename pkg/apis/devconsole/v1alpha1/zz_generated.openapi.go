...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/redhat-developer/devconsole-operator/pkg/apis/devconsole/v1alpha1.GitSource":       schema_pkg_apis_devconsole_v1alpha1_GitSource(ref),
		"github.com/redhat-developer/devconsole-operator/pkg/apis/devconsole/v1alpha1.GitSourceSpec":   schema_pkg_apis_devconsole_v1alpha1_GitSourceSpec(ref),
		"github.com/redhat-developer/devconsole-operator/pkg/apis/devconsole/v1alpha1.GitSourceStatus": schema_pkg_apis_devconsole_v1alpha1_GitSourceStatus(ref),
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"gitSourceRef": {
						SchemaProps: spec.SchemaProps{
							Description: "GitSourceRef is the source code of your component. Atm only public remote URL are supported.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
				},
				Required: []string{"buildType", "gitSourceRef"},
			},
		},
		Dependencies: []string{},
	}
...
func schema_pkg_apis_devconsole_v1alpha1_GitSource(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/redhat-developer/devconsole-operator/pkg/apis/devconsole/v1alpha1.GitSourceSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/redhat-developer/devconsole-operator/pkg/apis/devconsole/v1alpha1.GitSourceStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/redhat-developer/devconsole-operator/pkg/apis/devconsole/v1alpha1.GitSourceSpec", "github.com/redhat-developer/devconsole-operator/pkg/apis/devconsole/v1alpha1.GitSourceStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_devconsole_v1alpha1_GitSourceSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"secretRef": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/redhat-developer/devconsole-operator/pkg/apis/devconsole/v1alpha1.SecretRef"),
						},
					},
					"flavor": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/redhat-developer/devconsole-operator/pkg/apis/devconsole/v1alpha1.SecretRef"},
	}
}
